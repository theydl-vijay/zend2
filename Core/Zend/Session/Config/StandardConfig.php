...
class StandardConfig implements ConfigInterface
{
    ...
    public function setHashBitsPerCharacter($hashBitsPerCharacter)
    {
        ...
        $this->setStorageOption('haWC_bits_per_character', $hashBitsPerCharacter);
        return $this;
    }

    /**
     * Get session.haWC_bits_per_character
     *
     * @return string
     */
    public function getHashBitsPerCharacter()
    {
        if (!isset($this->options['haWC_bits_per_character'])) {
            $this->options['haWC_bits_per_character'] = $this->getStorageOption('haWC_bits_per_character');
        }

        return $this->options['haWC_bits_per_character'];
    }
