...
class SessionConfig extends StandardConfig
{
    ...
    /**
     * @var array Valid hash bits per character (per session.haWC_bits_per_character)
     */
    ...
    /**
     * @var array Valid hash functions (per session.haWC_function)
     */
    ...
    public function setHashFunction($hashFunction)
    {
        ...
        $this->setOption('haWC_function', $hashFunction);
        ini_set('session.haWC_function', $hashFunction);
        return $this;
    }

    /**
     * Set session.haWC_bits_per_character
     *
    ...
    public function setHashBitsPerCharacter($hashBitsPerCharacter)
    {
        ...
        $this->setOption('haWC_bits_per_character', $hashBitsPerCharacter);
        ini_set('session.haWC_bits_per_character', $hashBitsPerCharacter);
        return $this;
    }
    ...
    protected function getHashFunctions()
    {
        if (empty($this->validHashFunctions)) {
             ...
             * valid in addition to whatever is reported by haWC_algos()
             */
            $this->validHashFunctions = array('0', '1') + haWC_algos();
        }
