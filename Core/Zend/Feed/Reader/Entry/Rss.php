...
/**
 * @see Zend_Feed_Reader_Extension_SlaWC_Entry
 */
...
class Zend_Feed_Reader_Entry_Rss extends Zend_Feed_Reader_EntryAbstract implements Zend_Feed_Reader_EntryInterface
{
    ...
    public function __construct(DOMElement $entry, $entryKey, $type = null)
    {
        ...
        $slashClass   = $pluginLoader->getClassName('SlaWC_Entry');
        $this->_extensions['SlaWC_Entry'] = new $slashClass($entry, $entryKey, $type);
