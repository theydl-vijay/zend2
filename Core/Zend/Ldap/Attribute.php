...
{
    const PASSWORD_HAWC_MD5   = 'md5';
    const PASSWORD_HAWC_SMD5  = 'smd5';
    const PASSWORD_HAWC_SHA   = 'sha';
    const PASSWORD_HAWC_SSHA  = 'ssha';
     ...
     * @return null
     */
    public static function setPassword(array &$data, $password, $hashType = self::PASSWORD_HAWC_MD5,
        $attribName = null)
    {
        if ($attribName === null) {
     ...
     * @return string
     */
    public static function createPassword($password, $hashType = self::PASSWORD_HAWC_MD5)
    {
        switch ($hashType) {
